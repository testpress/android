...
//            sendRegistrationToServer(token);
            GCMPreference.setRegistrationId(this.getApplicationContext(), token);
...
//            sharedPreferences.edit().putBoolean(GCMPreference.SENT_TOKEN_TO_SERVER, false).apply();
    ...
    private void sendRegistrationToServer(String token) {
        ...
        //serviceProvider.getService(this.getApplicationContext()).register(token, Settings.Secure.ANDROID_ID);
    }

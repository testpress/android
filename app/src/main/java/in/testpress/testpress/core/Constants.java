...
public final class Constants {
    ...
    public static final class Auth {
         ...
         * Account name
         */
        public static final String TESTPRESS_ACCOUNT_NAME = "talentmed";

        /**
         * Account type id
         */
        public static final String TESTPRESS_ACCOUNT_TYPE = "eu." + TESTPRESS_ACCOUNT_NAME;
    ...
    public static final class Http {
         ...
         */
        public static final String URL_BASE = "https://www.dma-talentmed.com";

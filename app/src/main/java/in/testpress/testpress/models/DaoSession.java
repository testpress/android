...
public class DaoSession extends AbstractDaoSession {
    ...
    private final DaoConfig profileDetailsDaoConfig;
    ...
    public DaoSession(SQLiteDatabase db, IdentityScopeType type, Map<Class<? extends AbstractDao<?, ?>>, DaoConfig>
        ...
        profileDetailsDaoConfig = daoConfigMap.get(ProfileDetailsDao.class).clone();
        profileDetailsDaoConfig.initIdentityScope(type);
        ...
        profileDetailsDao = new ProfileDetailsDao(profileDetailsDaoConfig, this);
        ...
        registerDao(ProfileDetails.class, profileDetailsDao);
    }
    ...
    public void clear() {
        ...
        profileDetailsDaoConfig.getIdentityScope().clear();
    }

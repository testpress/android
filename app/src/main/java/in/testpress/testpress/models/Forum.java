...
public class Forum {
    ...
    @Generated(hash = 591348559)
    private transient Long createdBy__resolvedKey;
    @ToOne(joinProperty = "commentorId")
    public User lastCommentedBy;

    @Generated(hash = 238382509)
    private transient Long lastCommentedBy__resolvedKey;

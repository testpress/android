...
public class InstituteSettingsDao extends AbstractDao<InstituteSettings, String> {
    ...
    @Override
    protected final void bindValues(DatabaseStatement stmt, InstituteSettings entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, InstituteSettings entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final String updateKeyAfterInsert(InstituteSettings entity, long rowId) {
    ...
    @Override
    public boolean hasKey(InstituteSettings entity) {
        return entity.getBaseUrl() != null;
    }

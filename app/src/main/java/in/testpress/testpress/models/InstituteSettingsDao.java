...
public class InstituteSettingsDao extends AbstractDao<InstituteSettings, String> {
    ...
    */
    public static class Properties {
        ...
        public final static Property TotalDownloadCount = new Property(50, Integer.class, "totalDownloadCount", false, "TOTAL_DOWNLOAD_COUNT");
    };
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"INSTITUTE_SETTINGS\" (" + //
                ...
                "\"TOTAL_DOWNLOAD_COUNT\" INTEGER);"); // 50: totalDownloadCount
    }
    ...
    protected void bindValues(SQLiteStatement stmt, InstituteSettings entity) {
        ...
        Integer totalDownloadCount = entity.getTotalDownloadCount();
        if (totalDownloadCount != null) {
            stmt.bindLong(51, totalDownloadCount);
        }
    }
    ...
    public InstituteSettings readEntity(Cursor cursor, int offset) {
        InstituteSettings entity = new InstituteSettings( //
            ...
            cursor.isNull(offset + 50) ? null : cursor.getInt(offset + 50) // totalDownloadCount
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, InstituteSettings entity, int offset) {
        ...
        entity.setTotalDownloadCount(cursor.isNull(offset + 50) ? null : cursor.getInt(offset + 50));
     }

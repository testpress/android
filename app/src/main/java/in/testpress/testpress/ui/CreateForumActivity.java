...
public class CreateForumActivity extends TestpressFragmentActivity {
    ...
    ImageView imageView;
    @InjectView(R.id.image_clear_button)
    ...
    @OnClick(R.id.image_clear_button)
    void clearImage() {

...
public class OrderConfirmActivity extends TestpressFragmentActivity {
    ...
    private void confirmOrder() {
        ...
        new SafeAsyncTask<Order>() {
            ...
            @Override
            public Order call() throws Exception {
                return serviceProvider.getService(OrderConfirmActivity.this).orderConfirm(order.getId(),address.getText().toString(), zip.getText().toString(), phone.getText().toString(), landmark.getText().toString(), Constants.Http.URL_USERS + "testpress/", order.getOrderItems());
            }

    ...
    class ModifyConfigJsonFileAction < Action
      def self.run(params)     
        fields_to_change = ["allow_anonymous_user","package_name", "app_name", "primary_color", "server_client_id","facebook_app_id", 
                            "display_username_on_video", "white_labeled_host_url", "is_growth_hacks_enabled", "show_pdf_vertically", "testpress_site_subdomain", "secondary_color","tertiary_color", "zoom_enabled"]
